            ...
            <div class="container max-w-screen-lg mx-auto">
                <div class="flex flex-col items-center md:flex-row md:items-start">
                    <img
                        ...
                        :src="programme.primary_image"
                        alt="Programme image preview"
                    />

                    <section class="mt-8 text-center md:ml-8 md:mt-0 md:text-left">
                        <h1 class="text-3xl font-bold text-white md:text-4xl">{{ programme.name }}</h1>
                        <p class="mt-4 text-gray-400">{{ programme.summary }}</p>
        ...
        <section class="bg-white px-4 py-6 shadow-subtle mt-4">
            <div class="container max-w-screen-lg mx-auto">
                <div class="text-center">
                    <iframe :src="programme.video_preview" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </section>
