...
class OrganisationUnitIndexRequest extends BaseIndexRequest
{
    public function rules() : array
    {
        return array_merge(parent::rules(), [
            'organisation_unit_company_id'      => 'nullable|integer|exists:crm_organisation_units,id',
            'organisation_unit_location_id'     => 'nullable|integer|exists:crm_organisation_units,id',
            'organisation_unit_email'           => 'nullable|string',
            'organisation_unit_name'            => 'nullable|string',
            'organisation_unit_parent_id'       => 'nullable|integer|exists:crm_organisation_units,id',
